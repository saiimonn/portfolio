        ...
        <>
            <div className = "relative z-10 py-16 sm:py-24">
                <div className = "space-y-4 mb-10">
                    ...
                    <motion.p variants = {itemVars} initial = "hidden" whileInView = "visible" className = "font-light text-lg md:text-xl">I'm proficient in a variety of languages and frameworks, and I still aim to learn more.</motion.p>
                </div>
